...
class sentimentAnalysisGUI:
    ...
    def __init__(self, master):
        ...
        self.algLabel = Label(master, text="Algorithm")
        self.algLabel.pack()

        self.algorithms = Listbox(master,selectmode=SINGLE,height=2,exportselection=0)
        ...
        self.testLabel = Label(master, text="Test Set")
        self.testLabel.pack()
        self.testSet = Listbox(master,selectmode=SINGLE,height=1,exportselection=0)
        self.testSet.insert(1,"IMDB Movie test set")
        self.testSet.pack()
        
        self.test_button = Button(master, text="Test", command=self.callSelectionMethods)
